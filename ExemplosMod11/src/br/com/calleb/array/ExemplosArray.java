...
public class ExemplosArray {
    ...
    private static void arrayBidimensional() {
        ...
        System.out.println("Valores no array1 pasados na linha são");
        outputArray(array1); // exibe o array 1 por linha

        System.out.println("Valores no array 2 por linha são");
        outputArray(array2); // exibe o array 2 por linha
    }

    private static void outputArray(int[][] array) {
        // FAZ UM LOP PELAS LINHAS DO ARRAY
    ...
    private static void declaracaoArray() {
        System.out.println("\n****** declaracaoArray ******");
        // [] - são inseridos em uma váriavel que referencia um array
        int[] a = new int[4];
        // OUTRA MANEIRA DE FAZER UMA DECLARÇÃO DE ARRAY
        int[] b;
        b = new int[10];
        // DECLARANDO VÁRIOS ARRAYS
        int[] r = new int[44], k = new int[23];

        // {} - inicializar valores em um array sua declarção
