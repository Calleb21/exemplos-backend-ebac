...
public class ExemploArrayDeque {
    ...
    private static void acessandoDaFila() {
        ...
        System.out.println("Get last element using peekLast: " + ad.getLast());
        System.out.println();
    }

    private static void removandoDaFila() {
    ...
    private static void inserindoNaFila() {
        ...
        System.out.println("Elements in the Deque after offter, offterFirst and offterLast: " + d);
