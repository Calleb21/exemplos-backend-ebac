package br.com.calleb.reflections.anotacao.cadastro;

import br.com.calleb.reflections.anotacao.cadastro.dao.ClienteMapaDAO;
import br.com.calleb.reflections.anotacao.cadastro.dao.IClienteDAO;
import br.com.calleb.reflections.anotacao.cadastro.dao.IProdutoDAO;
import br.com.calleb.reflections.anotacao.cadastro.dao.ProdutoDAO;
import br.com.calleb.reflections.anotacao.cadastro.dao.generic.IGenericDAO;
...
import br.com.calleb.reflections.anotacao.cadastro.exception.TipoChaveNaoEncontradaException;
import br.com.calleb.reflections.anotacao.cadastro.fabrica.FabricaPersistente;
import br.com.calleb.reflections.anotacao.cadastro.fabrica.Factory;
import br.com.calleb.reflections.anotacao.cadastro.fabrica.IFactory;
...
public class App2 {
    ...
    private static void executarOpcoes(String opcao, String opcaoMenuGeral) {
        ...
        } catch (DadoInvalidosException e) {
    ...
    private static void executarOpcaoConsultar(String opcaoMenuGeral) {
        ...
        Persistence persistente = consultar(dados, opcaoMenuGeral);
        if (persistente != null) {
     ...
     */
    private static void executarOpcaoCadastrar(String opcaoMenuGeral) throws DadoInvalidosException {
        String dados = "";
    ...
    private static void inicializarDAO() {
        iClienteDAO = new ClienteMapaDAO();
     ...
     */
    private static Persistence consultar(String dados, String opcaoMenuGeral) {
     ...
     * @throws DadoInvalidosException quando os dados estão inválidos
     */
    private static void cadastrar(String dados, String opcaoMenuGeral) throws DadoInvalidosException {
        String[] dadosSeparados = dados.split(",");
        Persistence persistente = criarObjetoConcreto(dadosSeparados, opcaoMenuGeral);
     ...
     * @return
     */
    private static Boolean cadastrarObjeto(String opcaoMenuGeral, Persistence persistente) throws TipoChaveNaoEncontradaException {
     ...
     * @throws DadoInvalidosException quando os dados estão inválidos
     */
    private static Persistence criarObjetoConcreto(String[] dadosSeparados, String opcaoMenuGeral) throws DadoInvalidosException {
